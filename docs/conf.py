# -*- coding: utf-8 -*-
#
# bb_binary documentation build configuration file, created by
...
htmlhelp_basename = 'bb_binarydoc'
...
latex_documents = [
    (master_doc, 'bb_binary.tex', u'bb_binary Documentation',
     u'Benjamin Wild, Leon Sixt', 'manual'),
]
...
man_pages = [
    (master_doc, 'bb_binary', u'bb_binary Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bb_binary', u'bb_binary Documentation',
     author, 'bb_binary', 'One line description of project.',
     'Miscellaneous'),
]
...
def linkcode_resolve(domain, info):
    ...
    fn = relpath(fn, start=dirname(bb_binary.__file__))
    p = subprocess.Popen(['git', 'rev-parse', 'HEAD'], stdout=subprocess.PIPE)
    git_rev, err = p.communicate()
    git_rev = git_rev.decode('utf-8').rstrip('\n')
    return "https://github.com/BioroboticsLab/bb_binary/blob/{}/python/bb_binary/{}{}".format(
       git_rev, fn, linespec)
